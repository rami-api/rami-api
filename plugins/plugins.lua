...
local function list_all_plugins(only_enabled)
  ...
  local text = text..'\n\n'..nsum..' *📂الملفات المثبته 🎗*\n\n'..nact..' _✔️الملفات المفعله ✨_\n\n'..nsum-nact..' _❌الملفات المعطله 🐿_\n\n[KENAM-BOT](Telegram.Me/kenamch)'
  return text
end
...
local function run(msg, matches)
  ...
  if matches[1]:lower() == 'تحديث' and is_sudo(msg) then --after changed to moderator mode, set only sudo
    return reload_plugins(true)
  end
end
