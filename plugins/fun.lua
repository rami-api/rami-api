...
--Begin Fun.lua By @RAMBO_SYR
--Special Thx To @Xxx_DEVRAMI_xxX
--------------------------------
...
sleep(1)
sendDocument(msg.to.id, "./download_path/"..msg.to.id..".webp", msg.id, "@Xxx_DEVRAMI_xxX")
        end
     end
  end
-------------------------------- 
...
sleep(1)
sendPhoto(msg.to.id, "./download_path/"..msg.to.id..".jpg", "@Xxx_DEVRAMI_xxX", msg.id)
        end
     end
  end
--------------------------------
...
sendDocument(msg.to.id, file, msg.id, "@Xxx_DEVRAMI_xxX")
