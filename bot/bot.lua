...
if not tostring(SUDO):match('%d+') then
  ...
  config = {
   ...
   "plugins",
    ...
    sudo_users = {280911803, SUDO},--Sudo users
    master_id = SUDO, 
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[*》Syria Manager V7.0*
`》An advanced administration bot based on` *TEAM-DEV*

》[syria-SURCE](https://github.com/)

*》Admins :*
*》Developer :* [RAMI:(](Telegram.Me/RAMBO_SYR)

*》Special thanks to :*
`Beyond Team `

*》Our channel :*
》[TEAM-DEV](Telegram.Me/Xxx_DEVRAMI_xxX)

*》Our channel2 :*
[RAMI SYRIA](t.me/RAMBO_SYR1)
]],
  }
